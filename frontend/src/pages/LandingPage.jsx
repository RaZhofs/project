    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2.5">
          ...
          <span className={`text-lg font-bold tracking-tight transition-colors ${scrolled ? 'text-slate-800' : 'text-white'}`}>
            Convexa
          </span>
        </Link>
...
function EventoPublicoCard({ ev, mostrarRsvp }) {
  ...
  return (
    <article className="bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md
